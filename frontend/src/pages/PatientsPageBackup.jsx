...
export default function PatientsPageBackup() {
  ...
  const handleDelete = async (id) => {
    console.log('Intentando eliminar paciente con ID:', id, typeof id);
    if (window.confirm('¿Seguro que deseas eliminar este paciente?')) {
      try {
        ...
        alert(err.response?.data?.error || 'Error al eliminar el paciente.');
      }
    }
  };
